...
v1ta is the Solana-native, fully on-chain stablecoin — built for people who believe money should be trustless, efficient, and unstoppable.

## The Problem

Stablecoins aren't stable in principle anymore:

- **USDC / USDT:** Centralized custodians, blacklist risk, TradFi exposure
- **MakerDAO:** Governance committees, T-bills, and permissioned collateral
...
Borrow at just 110% collateral ratio. Lock $1000 SOL, borrow $909 VUSD. That's **11x better** than competitors at 150-200%.
...
- When VUSD trades below $1, arbitragers buy it cheap and redeem for $1
- When it trades above $1, people mint new VUSD at $1 and sell it higher

### Built for Solana Speed

- Sub-second transactions at pennies
- Dual oracles (Pyth + Switchboard) with 60-second staleness detection
- Compare that to hours of lag on Ethereum
...
<Cards>
  ...
  <Card
    ...
    description="Build with v1ta - API references and integration guides"
...
- **Pure collateral.** Pure code. Pure Solana.
- **Money without masters.**
- **The last pure stablecoin.**
...
- **Drift Protocol**: vUSD usable as collateral in perps & spot markets

## Launch Phases

1. **Devnet** — Core vault + Stability Pool + marginfi keeper demo
2. **Testnet** — Add redemptions & Drift integration
3. **Mainnet** — Audited, immutable contracts; ecosystem adoption
