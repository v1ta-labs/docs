...
A Collateralized Debt Position (CDP) is your personal vault in the v1ta protocol. This guide explains how CDPs work and how to manage them effectively.
...
**Formula:**
```
Max Borrowable = (Collateral Value USD / 1.105) - 0.5% fee
```

The 1.105 ensures you start with >110% CR after the 0.5% borrow fee.

**Example:**
```
Collateral: 10 SOL @ $100/SOL = $1,000
Max Borrowable: $1,000 / 1.105 = $904.98
After 0.5% fee: $904.98 - ($904.98 × 0.005) = $900.46
...
- **Remove collateral**: Lower your CR (must stay ≥110%)
- **Borrow more**: Increase debt (must maintain ≥110% CR)
- **Repay debt**: Reduce debt and improve CR

Your position must always maintain:
- **CR ≥ 110%**
- **Debt ≥ 1 VUSD** (unless closing completely)
...
| 150-200% | Healthy | Low | Good buffer |
| 130-150% | Moderate | Medium | Monitor price |
| 110-130% | At Risk | High | Add collateral soon |
| < 110% | Liquidatable | Critical | **Immediate liquidation risk** |
...
<Callout type="error">
  **DO NOT wait!** Liquidation happens automatically when CR < 110%. Act immediately.
</Callout>
...
|---------|----------|---------------------|
| Collateral Ratio | 110% | 150-200% |
| Interest | None (0.5% flat fee) | Variable APR |
| Liquidation | 5% penalty | 5-15% penalty |
