...
Want to integrate v1ta into your app or build tools on top of the protocol? You're in the right place.
...
- Basic Solana development experience
- Some familiarity with the Anchor framework
...
Here's how to open a position. This example shows you everything you need:
...
v1ta uses PDAs for all state accounts. Here's how to find them:
...
Fetching data from the protocol is straightforward:
