...
v1ta is built on top of marginfi, Solana's leading DeFi protocol, to provide flash liquidity and composable credit functionality.
...
v1ta leverages marginfi's flash loan capabilities for instant liquidity:
